...
try:
    ...
    try:
        ...
        for kbo_pitcher in kbo_pitchers:
            sql = """
            INSERT INTO kbo_Pitcher(player_id, player_name , player_href, player_team, player_era, player_game, player_win, player_lose, player_save, player_hrd, player_wpct)
